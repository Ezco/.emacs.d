...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel ivy use-package matlab-mode company-anaconda doom-themes naysayer-theme zenburn-theme darktooth-theme gruvbox-theme json-mode evil-commentary autothemer)))
